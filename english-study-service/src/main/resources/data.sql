insert into irregular_verbs values('1','be','was, were', 'been', 'быть, являться');
insert into irregular_verbs values('2','beat','beat', 'beaten', 'бить, колотить');
insert into irregular_verbs values('3','become','became', 'become', 'становиться');

insert into noun_verbs values('1', 'лікар', 'doctor', 'лікувати');
...
insert into grammar_tasks values('13', 'Does John run every morning?','Translate to the english using present simple: Джон бігає кожен ранок?','100');
...
insert into grammar_tasks values('23', 'Did John run every morning?','Translate to the english using present simple: Джон бігав кожен ранок?','102');
